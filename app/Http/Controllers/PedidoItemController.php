...
class PedidoItemController extends Controller
{
    ...
    {
        $pedidoItem->load('pedido');

        $pedido = $pedidoItem->pedido;
        $sessionRestauranteId = $this->restauranteId();


        dd([
        'Pedido Restaurante ID' => optional($pedido)->restaurante_id,
        'Sessão Restaurante ID' => $sessionRestauranteId
    ]);


        $isAuthorized = $pedido !== null && $pedido->restaurante_id === $this->restauranteId();
